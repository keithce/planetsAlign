...
package com.resonantrhythm.declinationliving;
...
//==============================================================================
public class declinationLiving   extends Activity
{
    //==============================================================================
    static
    {
               ...
               .setOnCancelListener (new DialogInterface.OnCancelListener()
                    {
                        ...
                        {
                            declinationLiving.this.alertDismissed (callback, 0);
                        }
                    })
               ...
               .setPositiveButton (okButtonText.isEmpty() ? "OK" : okButtonText, new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.dismiss();
                            declinationLiving.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.dismiss();
                            declinationLiving.this.alertDismissed (callback, 2);
                        }
                    })
